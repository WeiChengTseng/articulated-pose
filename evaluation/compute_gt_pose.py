...
if __name__ == '__main__':
    ...
    test_group = get_full_test(all_test_h5,
                               unseen_instances,
                               domain=args.domain,
                               spec_instances=special_ins)
    print('we have {} testing data for {} {}'.format(len(test_group),
                                                     args.domain, args.item))
    ...
    for i in range(len(test_group)):
        try:
            ...
            for j in range(num_parts):
                ...
                s, r, t, rt = estimateSimilarityUmeyama(
                    a.transpose(), c.transpose())
